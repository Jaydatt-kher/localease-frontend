...
export const adminApi = baseApi.injectEndpoints({
  endpoints: (builder) => ({
    getAdminKPIs: builder.query({
      query: () => "/api/admin/dashboard/kpis",
      providesTags: ["AdminDashboard"],
    }),
    getBookingsTrend: builder.query({
      query: (range = "last7days") => `/api/admin/dashboard/bookings-trend?range=${range}`,
      providesTags: (result, error, range) => [{ type: "AdminDashboard", id: `bookings-${range}` }],
    }),
    getRevenueTrend: builder.query({
      query: (range = "last7days") => `/api/admin/dashboard/revenue-trend?range=${range}`,
      providesTags: (result, error, range) => [{ type: "AdminDashboard", id: `revenue-${range}` }],
    }),
    getProviderStatus: builder.query({
      query: () => "/api/admin/dashboard/provider-status",
      providesTags: ["AdminDashboard"],
    }),
    getBookingStatus: builder.query({
      query: () => "/api/admin/dashboard/booking-status",
      providesTags: ["AdminDashboard"],
    }),
    getCategoryPopularity: builder.query({
      query: () => "/api/admin/dashboard/category-popularity",
      providesTags: ["AdminDashboard"],
    }),

    getUserStats: builder.query({
      query: () => "/api/admin/users/stats",
    ...
    blockUser: builder.mutation({
      query: (id) => ({ url: `/api/admin/users/${id}/block`, method: "PATCH" }),
      invalidatesTags: ["AdminUsers"],
    }),
    unblockUser: builder.mutation({
      query: (id) => ({ url: `/api/admin/users/${id}/unblock`, method: "PATCH" }),
      invalidatesTags: ["AdminUsers"],
    }),

    getProviderStats: builder.query({
      query: () => "/api/admin/providers/stats",
      providesTags: ["AdminProviders"],
    }),
    getPendingProviders: builder.query({
      query: () => "/api/admin/providers/pending-list",
      providesTags: ["AdminProviders"],
    ...
    getProviderById: builder.query({
      query: (id) => `/api/admin/providers/${id}`,
      providesTags: (result, error, id) => [{ type: "AdminProviders", id }],
    }),
    approveProvider: builder.mutation({
      query: (id) => ({ url: `/api/admin/providers/${id}/approve`, method: "PATCH" }),
      invalidatesTags: ["AdminProviders"],
    }),
    rejectProvider: builder.mutation({
      query: (id) => ({ url: `/api/admin/providers/${id}/reject`, method: "PATCH" }),
      invalidatesTags: ["AdminProviders"],
    }),
    blockProvider: builder.mutation({
      query: (id) => ({ url: `/api/admin/providers/${id}/block`, method: "PATCH" }),
      invalidatesTags: ["AdminProviders"],
    }),
    unblockProvider: builder.mutation({
      query: (id) => ({ url: `/api/admin/providers/${id}/unblock`, method: "PATCH" }),
      invalidatesTags: ["AdminProviders"],
    }),
    deleteProvider: builder.mutation({
      query: (id) => ({ url: `/api/admin/providers/${id}/delete`, method: "PATCH" }),
      invalidatesTags: ["AdminProviders"],
    }),

    getAdminServiceStats: builder.query({
      query: () => "/api/admin/services/stats",
    ...
    getAdminCategoryStats: builder.query({
      query: () => "/api/admin/categories/stats",
    ...
    getAdminBookingStats: builder.query({
      query: () => "/api/admin/bookings/stats",
    ...
    toggleNotificationRead: builder.mutation({
      query: (id) => ({ url: `/api/admin/notifications/${id}/toggle-read`, method: "PATCH" }),
      invalidatesTags: ["AdminNotifications"],
    }),
    deleteAdminNotification: builder.mutation({
      query: (id) => ({ url: `/api/admin/notifications/${id}`, method: "DELETE" }),
      invalidatesTags: ["AdminNotifications"],
    }),
    ...
    updateAdminPassword: builder.mutation({
      query: (data) => ({ url: "/api/admin/profile/password", method: "PUT", body: data }),
    }),
    adminSendOtpMobile: builder.mutation({
      query: () => ({ url: "/api/admin/profile/send-otp-mobile", method: "POST" }),
    }),
    adminVerifyOtpMobile: builder.mutation({
      query: (body) => ({ url: "/api/admin/profile/verify-otp-mobile", method: "POST", body }),
      invalidatesTags: ["AdminProfile"],
    }),

    getAdminCityStats: builder.query({
      query: () => "/api/admin/cities/stats",
    ...
    getAdminCities: builder.query({
      query: ({ page = 1, limit = 10, search = "" } = {}) => {
        const params = new URLSearchParams({ page, limit });
        if (search) params.set("search", search);
        return `/api/admin/cities?${params.toString()}`;
      },
      providesTags: ["AdminCities"],
    }),
    createAdminCity: builder.mutation({
      query: (data) => ({ url: "/api/admin/cities", method: "POST", body: data }),
      invalidatesTags: ["AdminCities"],
    }),
    updateAdminCity: builder.mutation({
      query: ({ id, ...data }) => ({ url: `/api/admin/cities/${id}`, method: "PUT", body: data }),
      invalidatesTags: ["AdminCities"],
    }),
