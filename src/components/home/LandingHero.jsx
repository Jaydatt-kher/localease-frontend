      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10 animate-fade-in-up">
          ...
          <p className="text-[clamp(0.9375rem,2vw,1.125rem)] text-muted dark:text-muted-dark max-w-xl mx-auto leading-relaxed font-body">
            Connect with verified plumbers, electricians, cleaners &amp; more —
            instantly book or get competitive quotes.
          </p>
          ...
          <div className="flex items-center justify-center gap-3 mt-6 flex-wrap">
            <button
              ...
              className="flex items-center gap-2 px-6 py-3 bg-primary text-white font-display font-bold rounded-2xl hover:bg-primary-hover transition-all shadow-lg shadow-primary/30 hover:-translate-y-0.5 text-sm"
            >
              Get Started Free <FiArrowRight size={15} />
            </button>
            <button
              onClick={() => navigate("/signin")}
              className="flex items-center gap-2 px-6 py-3 border border-border dark:border-border-dark text-foreground dark:text-foreground-dark font-display font-bold rounded-2xl hover:border-primary hover:text-primary transition-all text-sm"
            >
              Sign In
            </button>
          </div>
        ...
        {}
        <div
          className="animate-fade-in-up max-w-2xl mx-auto mb-6 relative"
